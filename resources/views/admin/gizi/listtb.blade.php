        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <input class="form-control" id="type" name="type" type="hidden" value="tb" >
                    ...
                    <div class="col-sm-12 form-group">
                        <label for="description">Jenis Kelamin Anak</label>
                        <select class="form-control" id="gender" name="gender">
                            <option value="male" >Lak-Laki</option>
                            <option value="female" >Perempuan</option>
                        </select>
                    </div>
                    <div class="col-sm-12 form-group">
                        <label for="tanggal">Tinggi Badan Anak (cm)</label>
                        <input class="form-control" id="name" name="name" type="number"  step="any" value="" >
                    </div>
